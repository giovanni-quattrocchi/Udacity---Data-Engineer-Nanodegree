...
user_table_create = ("""CREATE TABLE "users" (user_id int PRIMARY KEY, first_name varchar, last_name varchar,
                gender char(1), level varchar);
""")

song_table_create = ("""CREATE TABLE "songs" (song_id varchar PRIMARY KEY, title varchar NOT NULL, artist_id varchar NOT NULL,
                year int, duration numeric NOT NULL);
""")

artist_table_create = ("""CREATE TABLE "artists" (artist_id varchar PRIMARY KEY, name varchar NOT NULL, location varchar,
...
songplay_table_insert = ("""INSERT INTO "songplays"(songplay_id, start_time, user_id,
                ...
                session_id, location, user_agent) VALUES (DEFAULT,%s,%s,%s,%s,%s,%s,%s,%s)
